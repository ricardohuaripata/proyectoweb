...
public class Validacion {
	...
	public Validacion(Persona persona) {
		this.persona = persona;
	}
	// devuelve un mapa con los campos invalidos introducidos 
	public HashMap<String, String> errores() {
